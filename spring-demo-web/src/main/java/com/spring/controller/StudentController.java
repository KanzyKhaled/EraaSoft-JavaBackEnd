...
//    }
    ...
    @GetMapping("/{id}")
    public ResponseEntity<StudentDto> getStudentWithTeacherById(@PathVariable Long id) {
        return ResponseEntity.ok(studentService.getStudentWithTeacherById(id));
    }
