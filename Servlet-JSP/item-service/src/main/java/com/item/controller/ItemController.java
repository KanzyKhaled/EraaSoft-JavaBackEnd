...
public class ItemController extends HttpServlet { 
	...
	private DataSource itemDetailsDataSource;
	...
	public void init() throws ServletException {
		...
		itemDetailsService = new ItemDetailsServiceImpl(itemDetailsDataSource); // Initialize both
	...
	private void loadItems(HttpServletRequest request, HttpServletResponse response) {
		...
		request.setAttribute("itemDetailsService", itemDetailsService);
